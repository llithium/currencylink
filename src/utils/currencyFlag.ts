const CURRENCY_REGIONS: Record<string, string> = {
  ...
  BZD: "BZ", CAD: "CA", CDF: "CD", CHF: "CH", CLF: "CL", CLP: "CL",
  CNY: "CN", COP: "CO", CRC: "CR", CUC: "CU", CUP: "CU", CVE: "CV",
  CZK: "CZ", DJF: "DJ", DKK: "DK", DOP: "DO", DZD: "DZ", EGP: "EG",
  ERN: "ER", ETB: "ET", EUR: "EU", FJD: "FJ", FKP: "FK", GBP: "GB",
  GEL: "GE", GHS: "GH", GIP: "GI", GMD: "GM", GNF: "GN", GTQ: "GT",
  GYD: "GY", HKD: "HK", HNL: "HN", HTG: "HT", HUF: "HU", IDR: "ID",
  ...
  XCD: "AG", XCG: "CW", XPF: "PF", YER: "YE", ZAR: "ZA", ZMW: "ZM",
  ZWL: "ZW",
};
